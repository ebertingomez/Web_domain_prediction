...
# Create the training matrix. Each row corresponds to a web host and 
# each column to a word present in at least 10 web hosts and at 
# most 1000 web hosts. The value of each entry in a row is equal 
# to the tf-idf weight of that word in the corresponding web host

vec = TfidfVectorizer(decode_error='ignore', strip_accents='unicode',
                      encoding='latin-1', min_df=10, max_df=1000)
...
# Create the test matrix following the same approach as in the case 
